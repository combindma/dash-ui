<button type="button" {{ $attributes->class(['copy-to-clip js-copy-to-clip js-tooltip-trigger']) }}>
    <svg class="icon inline-block text-inherit fill-current leading-none shrink-0 w-3.5 h-3.5" viewBox="0 0 16 16">
