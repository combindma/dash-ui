<div class="relative">
    ...
    'search-input block w-full appearance-none box-border rounded-lg text-sm border-0 py-1.5 text-neutral-900 ring-1 ring-inset placeholder:text-neutral-500 focus:ring-2 focus:ring-inset focus:ring-primary-700',
