<div {{ $attributes->class(['top-bar fixed top-0 left-0 w-full overflow-hidden px-3 shadow-xs h-full bg-primary-900 z-4 lg:px-4']) }}>
    <div class="relative h-full gap-2 top-bar__inner">
        <div class="block lg:hidden">
            <button type="button" command="show-modal" commandfor="{{ $menuId }}" class="flex items-center rounded-md text-white p-1.5 hover:cursor-pointer hover:bg-neutral-600">
        ...
        <div class="ml-auto">
            <button type="button" class="flex items-center rounded-md bg-neutral-700/60 px-0.5 hover:cursor-pointer hover:bg-neutral-700 lg:pr-0.5 lg:py-0.5 lg:rounded-lg lg:pl-2" popovertarget="popover-user-menu">
            ...
            <x-dashui-popover id="popover-user-menu">
                {{ $userMenu }}
            </x-dashui-popover>
        </div>
    </div>
